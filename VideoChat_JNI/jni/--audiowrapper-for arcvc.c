...
jint Java_com_arcsoft_ais_arcvc_utils_audio_AudioCodec_audio_1codec_1init(JNIEnv *env,
...
jint Java_com_arcsoft_ais_arcvc_utils_audio_AudioCodec_audio_1encode(JNIEnv *env,
...
jint Java_com_arcsoft_ais_arcvc_utils_audio_AudioCodec_audio_1decode(JNIEnv *env,
