 ...
 *      ----------------------------------------------------------------
 *      ver0.0.1    09/21/2009  Kevin Hua   first draft
 *  
 *CodeReview Log:
...
template <typename _Tp, typename _Sequence = mm_deque<_Tp> >
class mm_stack : public stack<_Tp, _Sequence>
{
public:
};
